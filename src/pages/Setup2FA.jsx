...
export default function Setup2FA() {
    ...
    return (
      ...
      <p className="mb-4 text-gray-700">Scan this QR code with your authenticator app.<br/> Or enter the setup key manually below.<br /> Then click Next to verify.</p>
      <div className="bg-gray-100 p-4 flex justify-center">
        {qrSvg ? <div dangerouslySetInnerHTML={{ __html: qrSvg }} /> : <b>Loading QR...</b>}
      </div>
      <div className="mt-4">
        <span className="font-semibold">Setup Key:</span>
        <span className="ml-2 text-blue-700 font-mono break-all">{setupKey || <b>Loading...</b>}</span>
      </div>
